      ...
      <div className="ff-main-wrapper">
        <div className="ff-main-wrapper-left">
          ...
          <div className="my-3 regular-font font-size2 font-color2 fw-normal">
            ...
            are dedicated to providing real-time insights on interpreter data.
            Our platform is easy to use and provides access where it is needed,
            through our mobile app platform. We give you visibility into how and
            when an Interpreter will show up to your Deposition, Medical
            Evaluation or Court Appointment. Our technology ensures high-speed
            performance and airtight security. Sign up now to experience the
            power of{" "}
